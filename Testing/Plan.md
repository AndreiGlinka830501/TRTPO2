...
Основная цель данного документа состоит в том, чтобы описать план тестирования  приложения для платформы Android "CoinMarket". 
...
2. Запуск на более ранней версии андроид
3. Проверка добавления новой монеты на главное меню
4. Вывод графиков
5. Вывод детальной информации о монете
...
Результаты тестирования представлены в документе [Test](https://github.com/AndreyGlinka830501/TRTPO2/blob/main/Testing/Test.pdf).
